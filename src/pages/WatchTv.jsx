...
import SimilarTv from '../Movie/SimilarTv';

// Loader to fetch movie details by ID
export const ShowsLoader = async ({ params }) => {
    const { id } = params;
    const response = await fetch(`https://api.themoviedb.org/3/tv/${id}?api_key=c159ee7878e7f8810fe222cc22ca754e&language=en-US`); // Fetch movie data
                ...
                <div className="w-[100vw] md:w-[90vw] min-h-[100vh] mt-16 bg-zinc-900 px-1 md:px-6">
                    <Breadcrumb className="m-3">
                        <BreadcrumbList>
                            ...
                            <Slash />
                            <BreadcrumbItem>
                                <BreadcrumbPage className="text-zinc-400">{movie.original_name}</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                    ...
                    <div className="flex flex-col md:flex-row mt-3 px-3">
                        ...
                        <div className="flex-1 px-4">
                            ...
                            <div className="grid grid-flow-col gap-4 leading-7">
                                ...
                                <div>
                                    <p>
                                        <span className="font-medium">Release Date:</span> {movie.first_air_date ? movie.first_air_date : 'Unknown'}
                                    </p>
                                    <p>
                                ...
                                <div>
                                    <p>
                                        <span className="font-medium">Duration:</span> {movie.episode_run_time ? `${movie.episode_run_time} minutes` : 'Unknown'}
                                    </p>
                                    <p>
