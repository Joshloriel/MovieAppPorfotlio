...
const GenrePage = () => {
    ...
    useEffect(() => {
        const fetchMoviesByGenre = async () => {
            const url = `https://api.themoviedb.org/3/discover/movie?with_genres=${id}&language=en-US&api_key=c159ee7878e7f8810fe222cc22ca754e`;
    ...
    return (
        <div className="bg-zinc-800 px-3">
            <p className='text-3xl font-bold text-white pt-20 mb-3'> Results </p>
