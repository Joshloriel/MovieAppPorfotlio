...
const MoviePage = () => {
    ...
    const getMovieRequest = async () => {
        const url = 'https://api.themoviedb.org/3/movie/popular?language=en-US&page=1&api_key=c159ee7878e7f8810fe222cc22ca754e';
    ...
    return (
        <div className="bg-zinc-800 px-10 overflow-x-hidden">
            <p className='text-6xl text-center font-bold text-white pt-20 mb-5'> Movies </p>
            <p className='text-white text-2xl my-2 mx-3'>Popular</p>
            <div className='grid grid-cols-2 gap-2 md:grid-cols-6'>
                {movies.map((item, index) => (
                    <SwiperSlide className='flex h-[30vh] md:h-[50vh] justify-center position-relative md:justify-start' key={index}>
                        <div>
                            <img
